namespace MineCraft_Server_Launcher
{
	partial class NewServer
	{
		...
		private void InitializeComponent()
		{
			...
			this.radioCreateModeSurvival.TabStop = true;
